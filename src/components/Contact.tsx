  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-br from-blue-50 via-white to-purple-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[800px] bg-gradient-to-br from-blue-100 to-purple-100 rounded-full blur-3xl opacity-30"></div>
      </div>
          ...
          >
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm">ank8525@gmail.com</p>
              </div>
            </motion.a>

            {/* Phone */}
            <motion.a
              href="tel:+971507276711"
              className="flex items-center space-x-4 text-gray-600 hover:text-blue-600 transition-colors group"
              whileHover={{ x: 10 }}
            >
              <div className="w-12 h-12 bg-blue-50 rounded-lg flex items-center justify-center group-hover:bg-blue-100 transition-colors">
              ...
              <div>
                ...
                <p className="text-sm">+971 50 727 6711</p>
              </div>
            </motion.a>
